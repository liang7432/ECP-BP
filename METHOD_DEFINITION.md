...
The public method name is **Equivalence-Class Pricing-Based Branch-and-Price Algorithm (ECP-BP)**.

- **Full name**: Equivalence-Class Pricing-Based Branch-and-Price Algorithm.
- **Short name**: ECP-BP.
